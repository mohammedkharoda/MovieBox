...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
      <div className="max-w-lg sm:mx-auto sm:text-center flex w-fit items-center gap-4">
        <Image
      ...
      <div className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
        <p className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#f13c77] to-[#f5e6ad]">
          A Best Place where you can find all your Movie and Series
        </p>
      </div>
